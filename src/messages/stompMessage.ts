...
class StompMessage {
  private message: IMessage | null | undefined;
   ...
   */
  constructor(opts: { message: IMessage | null; receiverId: string; subscriptionOpts: ISpaceBunnySubscribeOptions }) {
  ...
  public getContent = <T = Record<string, unknown> | string>(): T => {
