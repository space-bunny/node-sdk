    ...
    value: function onReceive(callback, opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this2._createChannel('input', opts).then(function (ch) {
          return _when2.default.all([ch.checkQueue(_this2.deviceId() + '.' + _this2._inboxTopic, _this2._inputQueueArgs), ch.consume(_this2.deviceId() + '.' + _this2._inboxTopic, function (res) {
