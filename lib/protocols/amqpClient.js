  ...
  _createClass(AmqpClient, [{
    ...
    value: function onReceive(callback) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var localOpts = (0, _merge3.default)(_this2._subscribeArgs, opts);
    ...
    value: function publish(channel, message) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var localOpts = (0, _merge3.default)(_this3._publishArgs, opts);
        _this3._createChannel('output', localOpts).then(function (ch) {
          var _localOpts$routingKey = localOpts.routingKey,
              routingKey = _localOpts$routingKey === undefined ? undefined : _localOpts$routingKey,
              _localOpts$topic = localOpts.topic,
    ...
    value: function connect() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var connectionOpts = (0, _merge3.default)(_this5._connectionOpts, opts);
