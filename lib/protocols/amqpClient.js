...
var AmqpClient = function (_SpaceBunny) {
  ...
  _createClass(AmqpClient, [{
    ...
    value: function onReceive(callback, opts) {
      ...
      opts = (0, _merge5.default)(this._subscribeArgs, opts);
    ...
    value: function connect() {
      ...
      var connectionOpts = (0, _merge5.default)(this._connectionOpts, opts);
        ...
        _this5.getEndpointConfigs().then(function (endpointConfigs) {
          ...
          if (_this5.isConnected()) {
            ...
            if (_this5._tls) {
              ...
              connectionOpts = (0, _merge5.default)(connectionOpts, _this5._tlsOpts);
            } else {
