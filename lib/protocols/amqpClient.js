...
var AmqpClient = function (_SpaceBunny) {
  ...
  function AmqpClient(opts) {
    ...
    _this._subscribeArgs = { noAck: true, requeue: false, allUpTo: false };
  ...
  _createClass(AmqpClient, [{
    ...
    value: function onReceive(callback, opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this2._createChannel('input', opts).then(function (ch) {
          return _when2.default.all([ch.checkQueue(_this2.deviceId() + '.' + _this2._inputTopic, _this2._inputQueueArgs), ch.consume(_this2.deviceId() + '.' + _this2._inputTopic, function (res) {
            // Create message object
            var message = new _message2.default(res, _this2._deviceId, opts);
            ...
            callback(_this2._parseContent(res.content), res.fields, res.properties);
            // Check if ACK is needed
            if (_this2._autoAck(opts.ack)) {
              ch.ack(res, opts.allUpTo);
            }
          }, opts)]);
        }).then(function (res) {
          resolve(res);
    ...
    value: function _connect() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this5.getConnectionParams().then(function (connectionParams) {
    ...
    value: function _autoAck(ack) {
      if (ack) {
        if (!(0, _includes3.default)(CONFIG.ackTypes, ack)) {
