...
var AmqpClient = function (_SpaceBunny) {
  ...
  _createClass(AmqpClient, [{
    ...
    value: function publish(channel, message) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this3._createChannel('output', opts).then(function (ch) {
          var _opts = opts,
              _opts$routingKey = _opts.routingKey,
              routingKey = _opts$routingKey === undefined ? undefined : _opts$routingKey,
              _opts$topic = _opts.topic,
              topic = _opts$topic === undefined ? undefined : _opts$topic;

          var promises = [ch.checkExchange(_this3.deviceId()), ch.publish(_this3.deviceId(), _this3._routingKeyFor({ channel: channel, routingKey: routingKey, topic: topic }), Buffer.from(_this3._encapsulateContent(message)), opts)];
    ...
    value: function connect() {
      ...
      var connectionOpts = (0, _merge2.default)(this._connectionOpts, opts);
        ...
        _this5.getEndpointConfigs().then(function (endpointConfigs) {
          ...
          if (_this5.isConnected()) {
            ...
            if (_this5._tls) {
              ...
              connectionOpts = (0, _merge2.default)(connectionOpts, _this5._tlsOpts);
            } else {
