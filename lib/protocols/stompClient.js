      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        _this2.connect().then(function (client) {
          ...
          var subscriptionCallback = function subscriptionCallback(message) {
            ...
            var stompMessage = new _stompMessage2.default(message, _this2._deviceId, localOpts);
            ...
            callback(_this2._parseContent(stompMessage.body), stompMessage.headers);
        ...
        _this5.getEndpointConfigs().then(function (endpointConfigs) {
          ...
          if (_this5.isConnected()) {
            ...
            try {
              ...
              var headers = (0, _merge3.default)(_this5._connectionHeaders, {
