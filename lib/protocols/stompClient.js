...
var StompClient = function (_SpaceBunny) {
  ...
  function StompClient(opts) {
    ...
    _this._webSocketProtocol = 'ws://';
    _this._webSocketSecureProtocol = 'wss://';
    _this._webSocketEnpoint = 'ws';
            ...
            try {
              (function () {
                ...
                if ((typeof process === 'undefined' ? 'undefined' : _typeof(process)) === 'object' && '' + process === '[object process]') {
                  ...
                  var connectionString = '' + protocol + connectionParams.host + ':' + port + '/' + _this5._webSocketEnpoint;
                ...
                if (connectionParams.client) {
                  headers['x-queue-name'] = '' + _this5._stompSubscriptionPrefix + connectionParams.client;
                }
