  ...
  _createClass(MqttClient, [{
    ...
    value: function onReceive(callback) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var localOpts = (0, _merge3.default)({}, opts);
        _this2.connect().then(function (client) {
          ...
          client.subscribe(_this2._topics, (0, _merge3.default)(_this2._connectionOpts, localOpts), function (err) {
            if (err) {
              reject(err);
            } else {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this3.connect().then(function (client) {
          var _sendMessage = function _sendMessage() {
            ...
            client.publish(_this3._topicFor(null, channel), bufferedMessage, (0, _merge3.default)(_this3._connectionOpts, opts), function () {
              resolve(true);
            });
          };
          if (!client.connected) {
    ...
    value: function connect() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var localOpts = (0, _merge3.default)(_this6._connectionOpts, opts);
