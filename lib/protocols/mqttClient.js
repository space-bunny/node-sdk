    ...
    value: function onReceive(callback, opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this2.connect().then(function (client) {
          _this2._topics[_this2._topicFor(null, _this2._inboxTopic)] = opts.qos || _this2._connectionOpts.qos;
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this3.connect().then(function (client) {
          var _sendMessage = function _sendMessage() {
            ...
            client.publish(_this3._topicFor(null, channel), bufferedMessage, (0, _merge2.default)(_this3._connectionOpts, opts), function () {
              resolve(true);
            });
          };
          if (!client.connected) {
