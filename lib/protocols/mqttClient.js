...
var MqttClient = function (_SpaceBunny) {
  ...
  function MqttClient() {
    ...
    var _this = _possibleConstructorReturn(this, (MqttClient.__proto__ || Object.getPrototypeOf(MqttClient)).call(this, opts));
  ...
  _createClass(MqttClient, [{
    ...
    value: function onReceive(callback) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        _this2.connect().then(function (client) {
          _this2._topics[_this2._topicFor(null, _this2._inboxTopic)] = localOpts.qos || _this2._connectionOpts.qos;
          client.subscribe(_this2._topics, (0, _merge3.default)((0, _cloneDeep3.default)(_this2._connectionOpts), localOpts), function (err) {
            if (err) {
              reject(err);
            } else {
              client.on('message', function (topic, message) {
                // TODO filterMine and filterWeb
                callback(topic, (0, _utils.parseContent)(message));
              });
              resolve(true);
            }
          });
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this3.connect().then(function (client) {
          var _sendMessage = function _sendMessage() {
            var bufferedMessage = Buffer.from((0, _utils.encapsulateContent)(message));
            var localOpts = (0, _cloneDeep3.default)(opts);
            localOpts = (0, _merge3.default)((0, _cloneDeep3.default)(_this3._connectionOpts), localOpts);
            client.publish(_this3._topicFor(null, channel), bufferedMessage, localOpts, function () {
              resolve(true);
            });
          };
          if (!client.connected) {
    ...
    value: function connect() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var localOpts = (0, _cloneDeep3.default)(opts);
        localOpts = (0, _merge3.default)((0, _cloneDeep3.default)(_this6._connectionOpts), localOpts);
          ...
          if (_this6._mqttConnection !== undefined) {
            ...
            try {
              var mqttConnectionParams = {
                ...
                connectionTimeout: localOpts.connectionTimeout || _this6._connectionTimeout
              };
              if (_this6._tls) {
                mqttConnectionParams = (0, _merge3.default)(mqttConnectionParams, _this6._tlsOpts);
              }
              var client = _mqtt2.default.connect(mqttConnectionParams);
              client.on('error', function (reason) {
                _this6.emit('error', reason);
                reject(reason);
              });
              client.on('close', function (reason) {
                reject(reason);
                _this6.emit('close', reason);
                _this6._mqttConnection = undefined;
              });
    ...
    key: '_topicFor',
    value: function _topicFor(deviceId, channel) {
