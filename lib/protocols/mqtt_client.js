    ...
    value: function onReceive(callback, opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this2._connect().then(function (client) {
          client.subscribe(_this2._topicFor('input'), (0, _merge2.default)(_this2._connectionOpts, opts), function (err) {
            if (err) {
              reject(false);
            } else {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this3._connect().then(function (client) {
          client.on('connect', function () {
            client.publish(_this3._topicFor(channel), new Buffer(message), (0, _merge2.default)(_this3._connectionOpts, opts), function () {
              resolve(true);
            });
          });
        }).catch(function (reason) {
