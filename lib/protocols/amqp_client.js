    ...
    value: function _connect(opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        if (_this5._conn !== undefined) {
          ...
          var connectionString = 'amqp://' + connectionParams.deviceId + ':' + connectionParams.secret + '@' + connectionParams.host + ':' + connectionParams.protocols.amqp.port + '/' + connectionParams.vhost.replace('/', '%2f');
