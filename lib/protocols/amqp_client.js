    ...
    value: function onReceive(callback, opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this2._createChannel('input').then(function (channel) {
          ...
          return _this2._amqpChannels.input.checkQueue(_this2.deviceId() + '.' + _this2._inputTopic, _this2._inputQueueArgs);
        }).then(function () {
          return _this2._amqpChannels.input.consume(_this2.deviceId() + '.' + _this2._inputTopic, function (message) {
    ...
    value: function publish(channel, message) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _this3._createChannel().then(function (ch) {
          ...
          return _when2.default.all([_this3._amqpChannels.output.checkExchange(_this3.deviceId()), _this3._amqpChannels.output.publish(_this3.deviceId(), _this3._routingKeyFor(channel), bufferedMessage, opts)]);
        }).then(function (res) {
          resolve(res);
        }).catch(function (reason) {
          reject(reason);
        ...
        if (_this5._amqpConnection !== undefined) {
          ...
          if (_this5._ssl) {
            if (_this5._checkSslOptions()) {
              ...
              opts = (0, _merge2.default)(opts, _this5._sslOpts);
            } else {
              throw new _spacebunny_errors2.default.ApiKeyOrConfigurationsRequired('Missing required SSL connection parameters');
            }
          } else {
          ...
          _amqplib2.default.connect(connectionString, opts).then(function (conn) {
