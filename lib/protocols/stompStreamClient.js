  ...
  _createClass(StompStreamClient, [{
    ...
    value: function _attachStreamHook(streamHook) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        var _streamHook$stream = streamHook.stream,
            ...
            _streamHook$bindingKe = streamHook.bindingKey,
            bindingKey = _streamHook$bindingKe === undefined ? undefined : _streamHook$bindingKe;
        ...
        _this5.connect().then(function (client) {
          ...
          if (stream) {
            ...
            if (cache) {
              ...
              topic = _this5._cachedStreamTopicFor({ stream: stream });
            } else {
              // Uncached streams are connected to the stream exchange and create a temp queue
              topic = _this5._streamTopicFor({ stream: stream, bindingKey: bindingKey });
            ...
            topic = _this5._streamChannelTopicFor({ deviceId: deviceId, channel: channel, bindingKey: bindingKey });
          ...
          try {
            var subscriptionId = (0, _jsMd2.default)(tempQueue + '-' + topic);
            var subscription = client.subscribe(topic, messageCallback, _extends({}, subscriptionHeaders, {
              id: subscriptionId
            }));
            _this5._subscriptions[subscriptionId] = subscription;
            resolve((0, _merge2.default)(streamHook, { id: subscriptionId }));
          } catch (e) {
    ...
    value: function _streamChannelTopicFor() {
      ...
      var _params$deviceId = params.deviceId,
          ...
          type = _params$type === undefined ? this._exchangePrefix : _params$type,
          _params$bindingKey = params.bindingKey,
          bindingKey = _params$bindingKey === undefined ? this._defaultPattern : _params$bindingKey;
    ...
    value: function _cachedStreamTopicFor() {
      ...
      var topic = this.liveStreamByName(stream);
    ...
    value: function _streamTopicFor() {
      ...
      var _params$stream2 = params.stream,
          ...
          type = _params$type3 === undefined ? this._exchangePrefix : _params$type3,
          _params$bindingKey2 = params.bindingKey,
          bindingKey = _params$bindingKey2 === undefined ? this._defaultPattern : _params$bindingKey2;
