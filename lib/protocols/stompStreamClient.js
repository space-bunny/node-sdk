  ...
  _createClass(StompStreamClient, [{
    ...
    value: function _attachStreamHook(streamHook, opts) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        var cache = streamHook.cache || true;
    ...
    value: function _streamTopicFor(streamName, type, pattern) {
      return '/' + (type || this._channelExchangePrefix) + '/' + this.liveStreamByName(streamName) + '.' + (this._liveStreamSuffix + '/' + (pattern || this._defaultPattern));
    }
  }]);
