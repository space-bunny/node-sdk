...
var SpaceBunny = function () {
  ...
  _createClass(SpaceBunny, [{
      ...
      if (this._deviceId && this._secret || this._apiKey) {
        ...
        if (this._host && this._port && this._vhost) {
          ...
          try {
            ...
            var response = (0, _syncRequest2.default)('GET', uri, args);
            this._endpointConfigs = _humps2.default.camelizeKeys(JSON.parse(response.getBody()));
    ...
    value: function liveStreamByName(streamName) {
      var liveStream = (0, _filter2.default)(this._liveStreams, function (stream) {
    ...
    value: function _generateHostname(endpoint) {
      ...
      if (!(0, _startsWith2.default)(hostname, endpointProtocol)) {
