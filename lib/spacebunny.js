  ...
  _createClass(SpaceBunny, [{
    ...
    value: function getConnectionParams() {
      ...
      if (this._deviceId && this._secret || this._apiKey) {
        ...
        var hostname = this._generateHostname(endpoint);
        ...
        if (this._apiKey) {
          ...
          try {
            ...
            throw new _spacebunnyErrors2.default.EndPointError(ex);
          }
        ...
        if (this._host && this._port && this._vhost) {
          ...
          try {
            ...
            // uses endpoint passed from user, default endpoint otherwise
            var _hostname = this._generateHostname(endpoint);
            var _uri = '' + _hostname + endpoint.api_version + endpoint.path;
            var _args = { headers: { 'Access-Key-Client': this._client, 'Access-Key-Secret': this._secret } };
            var _response = (0, _syncRequest2.default)('GET', _uri, _args);
            this._endpointConfigs = _humps2.default.camelizeKeys(JSON.parse(_response.getBody()));
        ...
        throw new _spacebunnyErrors2.default.ApiKeyOrConfigurationsRequired('Missing Api Key or wrong connection parameters');
      }
    }
