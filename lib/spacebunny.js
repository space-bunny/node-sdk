...
var SpaceBunny = function (_EventEmitter) {
  ...
  function SpaceBunny() {
    ...
    _this._connectionParams = (0, _merge3.default)({}, _humps2.default.camelizeKeys(opts));
    _this._endpointConfigs = undefined;
    _this._endpoint = (0, _merge3.default)(CONFIG.endpoint, _this._connectionParams.endpoint);
  ...
  _createClass(SpaceBunny, [{
    ...
    value: function getEndpointConfigs() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        if (_this2._endpointConfigs !== undefined || _this2.isConnected()) {
        ...
        if (_this2._deviceId && _this2._secret || _this2._deviceKey) {
          ...
          var uri = (0, _urlJoin2.default)(hostname, _this2._endpoint.deviceConfigurationsPath);
          ...
          if (_this2._host && _this2._port && _this2._vhost) {
            ...
            var _uri = (0, _urlJoin2.default)(_hostname, _this2._endpoint.liveStreamKeyConfigurationsPath);
            var _options = {
              url: _uri,
              method: 'get',
              responseType: 'json',
    ...
    value: function tempQueue(prefix, suffix, currentTime) {
      ...
      return (0, _uuidV2.default)() + '-' + timestamp + '-' + deviceId + '-' + (this.exchangeName(prefix, suffix) + '.') + ('' + this._tempQueueSuffix);
    }
    ...
    value: function _generateHostname() {
      ...
      var port = this._tls ? this._endpoint.securePort : this._endpoint.port;
      var hostname = this._endpoint.host + ':' + port;
